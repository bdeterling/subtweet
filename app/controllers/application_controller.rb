class ApplicationController < ActionController::Base
  ...
  def oauth_header(uri)
    ...
    request = OAuth::RequestProxy.proxy "method" => 'GET', "uri" => uri, "parameters" => { "oauth_consumer_key" => Consumer_key, "oauth_timestamp" => timestamp, "oauth_token" => Token, "oauth_version" => "1.0", "oauth_nonce" => nonce, "oauth_signature_method" => 'HMAC-SHA1' }.merge(parameters)
